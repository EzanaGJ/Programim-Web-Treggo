...
function sendEmail($data){
    ...
    try {   //Server settings
        ...
        $mail->Username = 'treggonoreply@gmail.com';                     //SMTP username
        $mail->Password = 'hlkb sutv sufi zrrk';                               //SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
        $mail->Port = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

        $mail->setFrom('treggonoreply@gmail.com', 'Treggo No Reply');
        $mail->addAddress($data["user_email"]);
//        $mail->addReplyTo('text@example.com', 'No Reply');
